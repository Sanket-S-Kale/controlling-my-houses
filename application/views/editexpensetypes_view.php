...
<body id="wrapper">
    ...
    <div class="col-xs-12 col-md-9 col-lg-10">
        <section class="p-20">
            <h2 class="my-h2">Edit Expense Types</h2>
          ...
          <?php } ?>
          <form name="myforms" novalidate action= <?php echo site_url('expensetypes/updateexpensetypes');  ?> method="post"  onsubmit="validateForms();">
            <input type="hidden" name="type_id" value="<?php echo $this->uri->segment(3);?>">
     ...
     <input type="submit"  name="submit" value="Edit" class="col-lg-2">
 </form>
</section>
<br/>
